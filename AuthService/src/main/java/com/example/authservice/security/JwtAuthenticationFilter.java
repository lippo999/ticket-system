 ...
 * This filter runs once per request and sets up the SecurityContext with user
 * permissions.
 */
@Component
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            try {
                ...
                // validateTokenAndGetClaims already checks expiration and blacklist
                ...
                // Don't set authentication, let the request continue (will be blocked by
                // security rules)
            }
        }
